...
const Hero = () => {
  return (
    ...
    <nav className="flex justify-between items-center w-full mb-10 pt-3">
      ...
      <button type="button" onClick={()=> window.open('https://github.com/AkarshanGupta/AkarshanGupta', '_blank')} className="black_btn">GitHub</button>
    </nav>

    <h1 className="head_text">Summarize Articles with <br className="max-md:hidden" />
    <span className="orange_gradient">ClaritySnap</span></h1>
